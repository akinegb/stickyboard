window.onload = function(){
	...
	var Box = React.createClass({
		...
		render: function(){
			return <div onClick={this.update} style={this.state}></div>
		}
	});

	ReactDOM.render(<Box colors="Red,DarkGreen,Purple,Pink,Chartreuse"/>,document.getElementById('react-container'));
